...
<head>
<meta charset="UTF-8">
<title>나랑 같이 놀쥬 :: 나만의 노하우 수정</title>
  ...
  <div class="card">
    <form action="howupdatesave" method="post" enctype="multipart/form-data">
      ...
      <table>
        <tr>
          <th>제목</th>
          <td><input type="text" name="howtitle" value="${dto.posttitle}" required></td>
        </tr>
        <tr>
          <th>내용</th>
          <td><textarea rows="10" name="howdetail" required>${dto.postdetail}</textarea></td>
        </tr>
        <tr>
          <th>현재 이미지</th>
          <td>
        ...
        <tr>
          <th>이미지 변경</th>
          <td><input type="file" name="howimg" accept="image/*"></td>
        </tr>
      </table>

      <div class="button-group">
        <input type="submit" class="btn btn-submit" value="수정">
        <input type="button" onclick="location.href='howout'" class="btn btn-cancel" value="취소">
      </div>
