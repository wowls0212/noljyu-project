  ...
  <div class="card">
    <form action="howsave" method="post" enctype="multipart/form-data">
      ...
      <table>
        ...
        <tr>
          <th>제목</th>
          <td><input type="text" name="howtitle" required></td>
        </tr>
        <tr>
          <th>내용</th>
          <td><textarea rows="10" name="howdetail" placeholder="내용을 입력하세요" required></textarea></td>
        </tr>
        <tr>
          <th>이미지</th>
      ...
      <div class="button-group">
        ...
        <input type="button" class="btn btn-cancel" value="취소" onclick="location.href='howout'">
      </div>
