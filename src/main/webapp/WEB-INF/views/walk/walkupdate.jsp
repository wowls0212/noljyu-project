...
<body>
  ...
  <div class="container">
	...
	<!-- 폼 -->
    <div class="card">
	  <form action="walkupdatesave" method="post" enctype="multipart/form-data">
	    <input type="hidden" name="walknum" value="${dto.walknum}">
    	<input type="hidden" name="originimg" value="${dto.walkimg}">
    	<input type="hidden" name="id" value="${id}">
    	  
    	<table>    	  	
    	  <caption class="sr-only">나만의 산책코스 수정 폼</caption>   	  
    	
	      <!-- 아이디 -->  
	      <tr>
	          <th>아이디</th>
	          <td><input type="hidden" name="id" value="${id}" readonly>${id}</td>
	      </tr>
	      
	      <!-- 제목 -->
	      <tr>
	          <th>제목</th>
	          <td><input type="text" name="walktitle" value="${dto.walktitle}" readonly></td>
	      </tr>
	      ...
	      <tr>
	          <th>내용</th>
	          <td><textarea rows="8" name="walkdetail" required>${dto.walkdetail}</textarea></td>
	      </tr>
		  ...
		  <!-- 버튼 -->
			  <div class="button-group">
			     ...
			     <input type="button" value="취소" class="btn-cancel" onclick="location.href='walkdetail?walknum=${dto.walknum}';">
			  </div>
	  </form>
	</div>
   </div>	
