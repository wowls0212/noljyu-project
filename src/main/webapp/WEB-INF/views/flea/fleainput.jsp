...
<head>
<meta charset="UTF-8">
<title>나랑 같이 놀쥬 :: 플리마켓 글 등록</title>
  ...
  <div class="card">
    <form action="fleasave" method="post" enctype="multipart/form-data">
      ...
      <table>
        ...
        <tr>
          <th>제목</th>
          <td><input type="text" name="fleatitle" required></td>
        </tr>
        <tr>
          <th>내용</th>
          <td><textarea rows="10" name="fleadetail" required></textarea></td>
        </tr>
        <tr>
          <th>이미지</th>
      ...
      <div class="button-group">
        ...
        <input type="reset" class="btn btn-cancel" value="취소" onclick="location.href='fleaout'">
      </div>
