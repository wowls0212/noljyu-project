...
<head>
<meta charset="UTF-8">
<title>나랑 같이 놀쥬 :: 플리마켓 글 수정</title>
  ...
  <div class="card">
    <form action="fleaupdatesave" method="post" enctype="multipart/form-data">
      ...
      <table>
        <tr>
          <th>제목</th>
          <td><input type="text" name="fleatitle" value="${dto.posttitle}" required></td>
        </tr>
        <tr>
          <th>내용</th>
          <td><textarea name="fleadetail" required>${dto.postdetail}</textarea></td>
        </tr>
        <tr>
          <th>현재 이미지</th>
          <td class="img-box">
            <img src="./image/${dto.postimg}" alt="현재 등록된 이미지">
          </td>
        </tr>
        <tr>
          <th>이미지 변경</th>
      ...
      <div class="button-group">
        ...
        <input type="button" onclick="location.href='fleaout'" class="btn btn-cancel" value="취소">
      </div>
    </form>
  </div>
